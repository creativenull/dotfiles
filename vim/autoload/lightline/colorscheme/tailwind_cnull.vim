...
" Defaults
let s:middle_section = [ ['NONE', s:bg_dark] ]
...
let s:warn_section = [ [s:text_softdark, s:warn] ]
...
let s:p.normal.warning = s:warn_section
...
let s:p.insert.error = s:error_section
let s:p.insert.warning = s:warn_section
...
let s:p.visual.error = s:error_section
let s:p.visual.warning = s:warn_section
...
let s:p.command.error = s:error_section
let s:p.command.warning = s:warn_section
...
let s:p.inactive.error = s:error_section
let s:p.inactive.warning = s:warn_section
