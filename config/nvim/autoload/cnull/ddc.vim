function! cnull#ddc#Setup() abort
  ...
  call ddc#custom#patch_global({
    ...
    \ 'sourceOptions': {
      ...
      \ 'nvim-lsp': s:sourceOptions.nvimlsp,
      \ 'vsnip': s:sourceOptions.vsnip,
      \ 'around': s:sourceOptions.around,
      \ 'buffer': s:sourceOptions.buffer,
      \ 'file': s:sourceOptions.file,
    \ },
    \ 'sourceParams': {
      \ 'nvim-lsp': s:sourceParams.nvimlsp,
    \ },
  \ })
